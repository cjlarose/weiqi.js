...
var _Weiqi = require("./index");

var _Weiqi2 = _interopRequireDefault(_Weiqi);

if (typeof window !== "undefined") window.Weiqi = _Weiqi2["default"];
...
var _createGame = require('./lib/game');

var _createBoard = require('./lib/board');
...
exports['default'] = {
  createGame: _createGame.createGame,
  createBoard: _createBoard.createBoard,
  EMPTY: _Constants2['default'].EMPTY,
  BLACK: _Constants2['default'].BLACK,
  WHITE: _Constants2['default'].WHITE
};
module.exports = exports['default'];

},{"./lib/board":4,"./lib/constants":5,"./lib/game":6}],4:[function(require,module,exports){
"use strict";
...
var _opponentColor = require("./util");
...
var Point = (function (_Immutable$Record) {
  ...
  return Point;
})(_Immutable2["default"].Record({ i: 0, j: 0 }));
...
var Group = (function (_Immutable$Record2) {
  ...
  return Group;
})(_Immutable2["default"].Record({ stones: null, surrounding: null }));
...
var replaceStone = function replaceStone(stones, coords, value) {
  if (value === _Constants2["default"].EMPTY) {
...
var getGroup = function getGroup(stones, size, coords) {
  ...
  var search = (function (_search) {
    ...
    return search;
  })(function (visited, queue, surrounding) {
  ...
  var _search2 = search(_Immutable2["default"].Set(), _Immutable2["default"].List([coords]), _Immutable2["default"].Map());

  var visited = _search2.visited;
  var surrounding = _search2.surrounding;
...
var Board = (function () {
  ...
  _createClass(Board, [{
    ...
    value: (function (_getStone) {
      function getStone(_x4) {
        return _getStone.apply(this, arguments);
      }

      getStone.toString = function () {
    ...
    value: function getIntersections() {
      ...
      var range = _Immutable2["default"].Range(0, this.size);
    ...
    value: function play(color, coords) {
      ...
      var isOpponentColor = function isOpponentColor(stoneColor, _) {
        return stoneColor === _opponentColor.opponentColor(color);
      };
...
},{"./constants":5,"./util":7,"immutable":1}],5:[function(require,module,exports){
"use strict";
...
var _createBoard = require("./board");
...
var Game = (function () {
  function Game(boardSize, values) {
    ...
    if (typeof values !== "undefined") {
      ...
      this.board = _createBoard.createBoard(boardSize);
  ...
  _createClass(Game, [{
    ...
    value: function play(player, coords) {
      ...
      return createGame(this.boardSize, {
        currentColor: _opponentColor.opponentColor(this.currentColor),
...
},{"./board":4,"./constants":5,"./util":7,"immutable":1}],7:[function(require,module,exports){
"use strict";
